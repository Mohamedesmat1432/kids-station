<div x-data="{ langMenu: false }" @click.away="langMenu = false" @close.stop="langMenu = false"
    ...
    <a @click="langMenu = ! langMenu" class="cursor-pointer flex text-gray-500 hover:text-gray-700">
