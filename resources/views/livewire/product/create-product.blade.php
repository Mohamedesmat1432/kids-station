<div>
    <x-create-button permission="create-product" />

    <x-dialog-modal wire:model="create_modal" submit="save()" method="POST">
        <x-slot name="title">
            <div class="flex justify-between">
                <div>{{ __('site.create_new_product') }}</div>
            </div>
        </x-slot>
        ...
        <x-slot name="content">
            <div class="grid md:grid-cols-3 md:gap-2">
                ...
                <div class="relative z-0 w-full mb-3 group">
                    ...
                    <x-input type="text" class="mt-1 block w-full" wire:model="description"
                        placeholder="{{ __('site.description') }}" autocomplete="description" />
                    <x-input-error for="description" class="mt-2" />
                </div>
                <div class="relative z-0 w-full mb-3 group">
                    <x-label for="purchase_price" value="{{ __('site.purchase_price') }}" />
                    <x-input type="text" class="mt-1 block w-full" wire:model="purchase_price" wire:keyup="revenuePrice"
                        placeholder="{{ __('site.purchase_price') }}" autocomplete="purchase_price" />
                ...
                <div class="relative z-0 w-full mb-3 group">
                    ...
                    <x-input type="text" class="mt-1 block w-full" wire:model="revenue_price"
                        placeholder="{{ __('site.revenue_price') }}" autocomplete="revenue_price" />
                ...
                <div class="relative z-0 w-full mb-3 group">
                    ...
                    <x-select wire:change="quantity" class="mt-1 block w-full" wire:model="unit_id">
