    ...
    <x-dialog-modal wire:model.live="edit_modal" submit="save()" method="PATCH">
        ...
        <x-slot name="content">
            ...
            <div class="col-span-6 sm:col-span-4 mt-3">
                ...
                <x-input id="newFile" type="file" class="mt-1 block w-full" wire:model="form.newFile" />
                <x-input-error for="form.newFile" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4 mt-3">
                <x-label for="file" value="{{ __('Files') }}" />
                <x-input id="newFiles" type="file" class="mt-1 block w-full" wire:model="form.newFiles"
                    multiple />
