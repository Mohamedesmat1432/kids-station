                ...
                <div class="flex z-40">
                    <div class="w-1/3 p-2 bg-gray-800 h-screen">
                        ...
                        <div class="users-list overflow-y-auto">
                            ...
                            @foreach ($users as $user)
                                <span class="flex text-white py-3 border-b border-gray-400 cursor-pointer"
                    ...
                    @if ($reciever_id)
                        <div class="w-2/3 p-2 bg-gray-800 h-screen">
                            ...
                            <div class="overflow-y-auto end-auto p-2 border-l border-l-gray-400" style="height: 450px;">
                                <ul class="list-none" id="chat-messages" wire:poll>
