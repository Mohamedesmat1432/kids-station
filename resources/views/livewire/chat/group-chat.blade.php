<div>
    ...
    <div class="relative">
        ...
        @if ($toggle_chat)
            <div wire:transition.duration.300ms class="fixed left-0 top-0 min-h-screen w-full bg-gray-800 p-2 z-40">
                <div class="flex justify-between">
                    <div class="p-2 w-1/3">
                        ...
                        <div class="emoji mt-3" x-data="{ open: false }">
                            ...
                            <div x-show="open" class="overflow-y-scroll h-52" wire:transition.duration.300ms>
                    ...
                    @if ($count_messages > 0)
                        <div class="overflow-y-scroll p-2 border-l border-l-gray-400 w-full" style="height: 550px;"
                            wire:poll>
                            <ul class="list-none">
